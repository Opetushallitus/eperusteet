  ...
  .controller("OpasSisaltoController", function(
    ...
    $scope.$watch(
      ...
      function() {
        Algoritmit.kaikilleLapsisolmuille(
          $scope.peruste.sisalto,
          "lapset",
          function(lapsi) {
            lapsi.$url = $state.href(
    ...
    $scope.rajaaSisaltoa = function(value) {
      ...
      var sisaltoFilterer = function(osa, lapsellaOn) {
        osa.$filtered =
          lapsellaOn ||
          Algoritmit.rajausVertailu(value, osa, "perusteenOsa", "nimi");
        return osa.$filtered;
      };
      Algoritmit.kaikilleTutkintokohtaisilleOsille(
        $scope.peruste.sisalto,
        sisaltoFilterer
      );
    };
    ...
    Editointikontrollit.registerCallback({
      ...
      save: function() {
        TekstikappaleOperations.updateViitteet(
          $scope.peruste.sisalto,
          function() {
