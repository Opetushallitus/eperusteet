...
angular.module('eperusteApp')
    .service('LukiokoulutusService', function (LukionOppiaineet, $q, SuoritustapaSisalto, $log, Notifikaatiot, LukiokoulutuksenSisalto, LukioKurssit, LukiokoulutusYleisetTavoitteet, LukiokoulutusAihekokonaisuudet) {
    mayBeUsed($log);
    ...
    .service('LukioKurssiService', function (LukioKurssit, Lukitus, Notifikaatiot, LukiokoulutusService, $translate, $q, $log) {
    ...
    var save = function (kurssi) {
        ...
        }, kurssi, success(d, 'tallennus-onnistui'), Notifikaatiot.serverCb);
        return d.promise;
    };
    ...
    .service('LukioAihekokonaisuudetService', function (LukiokoulutusAihekokonaisuudet, Lukitus, Notifikaatiot, LukiokoulutusService, $translate, $q) {
