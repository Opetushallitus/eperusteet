...
angular
    ...
    .controller("LukioAihekokonaisuudetController", function(
        $scope,
        ...
        Editointikontrollit.registerCallback({
            ...
            save: function(kommentti) {
                ...
                LukioAihekokonaisuudetService.saveAihekokonaisuudetYleiskuvaus(
            ...
            validate: function() {
                return $filter("kaanna")($scope.aihekokonaisuudet.otsikko) != "";
            },
            notify: function() {}
        });
        ...
        function init() {
            ...
            if (versio) {
                VersionHelper.getLukioAihekokonaisuudetVersions($scope.versiot, {}, true, function(versiot) {
                    ...
                    LukioAihekokonaisuudetService.getAihekokonaisuudetYleiskuvaus(revNumber).then(function(
                        aihekokonaisuudet
                    ) {
            ...
            Varmistusdialogi.dialogi({
                ...
                successCb: function() {
                    LukioAihekokonaisuudetService.deleteAihekokonaisuus(aihekokonaisuusId).then(function() {
                        $state.go(
                            "root.perusteprojekti.suoritustapa.lukioosat",
                            { osanTyyppi: LukiokoulutusService.AIHEKOKONAISUUDET },
                            { reload: true }
                        );
                    });
    ...
    .controller("LukioAihekokonaisuusController", function(
        $scope,
        $state,
        $stateParams,
        Lukitus,
        ...
        Editointikontrollit.registerCallback({
            ...
            validate: function() {
                return $filter("kaanna")($scope.aihekokonaisuus.otsikko) != "";
            },
            notify: function() {}
        });
        ...
        function init() {
            ...
            if (versio) {
                VersionHelper.getLukioAihekokonaisuusVersions(
                    $scope.versiot,
                    { id: $stateParams.osanId },
                    true,
                    function(versiot) {
                        var revNumber = VersionHelper.select($scope.versiot, versio);
