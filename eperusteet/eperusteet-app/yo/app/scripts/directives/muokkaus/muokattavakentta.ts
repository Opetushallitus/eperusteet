        ...
        link: (scope, element) => {
            ...
            $q.all({
                ...
                if (!scope.field.mandatory) {
                    const contentFrame = angular.element('<vaihtoehtoisen-kentan-raami></vaihtoehtoisen-kentan-raami>')
            ...
            const mapperFns = {
                addEditorAttributesFor: element => {
                    ...
                    const placeholder = scope.field.placeholder ? scope.field.placeholder :
            ...
            function wrapEditor(element) {
                ...
                const viewWrapper = angular.element('<div ng-if="!field.$editing" ng-bind-html="valitseKieli(object.' +
