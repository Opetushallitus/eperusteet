...
angular.module('eperusteApp')
  .controller('valmaarviointiCtrl', function ($scope, YleinenData, $timeout, Utils, Varmistusdialogi ) {
    ...
    $scope.isArviointi = ($scope.type === 'arviointi' || ($scope.$parent.field && $scope.$parent.field.valmatype === 'arviointi'));
    $scope.$$valmaOpen = true;

    $scope.valmaarviointi = ( !$scope.isArviointi && !_.isArray($scope.valmaarviointi) ) ? [$scope.valmaarviointi] : $scope.valmaarviointi;
