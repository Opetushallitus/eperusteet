...
.controller('TermiPluginController', ($scope, TermistoService, Kaanna, Algoritmit, $timeout) => {
...
.directive('ckeditor', ($q, $filter, $rootScope, editorLayouts, $timeout, Kaanna, EpImageService) => {
    return {
        priority: 10,
        restrict: 'A',
        require: 'ngModel',
