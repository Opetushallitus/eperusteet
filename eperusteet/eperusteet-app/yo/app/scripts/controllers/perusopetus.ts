...
angular
    .module("eperusteApp")
    .controller("PerusopetusSisaltoController", function(
        $scope,
        ...
        $scope.$esitysurl = YleinenData.getPerusteEsikatseluHost() + "/perusopetus/" + $scope.peruste.id + "/tiedot";
    ...
    .controller("PerusopetusController", function(
        $q,
        $scope,
        $timeout,
        sisalto,
        ...
        function isCurrentOppiaine(item) {
            ...
            return (
                $scope.valittuOppiaine && $scope.valittuOppiaine.oppiaine && $scope.valittuOppiaine.oppiaine.id === id
            );
        }
        ...
        function selectOppiaine(oppiaine) {
            ...
            Oppiaineet.get(
                { perusteId: peruste.id, osanId: id },
                function(res) {
