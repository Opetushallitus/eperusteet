...
angular
    .module("eperusteApp")
    .service("LukiokurssiModifyHelpers", function(
        Koodisto,
        MuokkausUtils,
        $translate,
        $filter,
    ...
    .controller("NaytaLukiokurssiController", function(
        $scope,
        $state,
        LukioKurssiService,
        $stateParams,
        ...
        Kommentit.haeKommentit(KommentitByPerusteenOsa, {
            ...
            perusteenOsaId: $stateParams.kurssiId
        });
    ...
    .controller("LisaaLukioKurssiController", function(
        $scope,
        $state,
        $q,
        $stateParams,
    ...
    .controller("MuokkaaLukiokurssiaController", function(
        $scope,
        $state,
        LukioKurssiService,
        $stateParams,
