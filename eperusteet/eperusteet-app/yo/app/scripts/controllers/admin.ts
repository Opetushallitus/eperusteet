...
.controller('AdminPerusteprojektitController', ($rootScope, $scope, PerusteProjektit, Algoritmit, PerusteprojektiTila,
                                                Notifikaatiot, Kaanna, YleinenData, Varmistusdialogi, Utils,
