...
angular.module('eperusteApp')
    .controller('KoulutuksenOsaOsaAlueCtrl', function ($scope, $state, $stateParams, Editointikontrollit, TutkinnonOsanOsaAlue, Lukitus, Notifikaatiot, Utils) {
    ...
    var osaAlueCallbacks = {
        ...
        save: function () {
            ...
            $scope.osaAlue.valmaTelmaSisalto = {
                ...
                osaamisenarviointi: {
                    tavoitteet: _.map($scope.valma.valmaarviointi.tavoitteet, function (tavoite) { return _.omit(tavoite, 'jarjestys'); }),
...
angular.module('eperusteApp')
    ...
    $scope.addFieldToVisible = function (field) {
        field.visible = true;
        $scope.editableTutkinnonOsaViite.tutkinnonOsa.valmaTelmaSisalto = ($scope.editableTutkinnonOsaViite.tutkinnonOsa.valmaTelmaSisalto) ? $scope.editableTutkinnonOsaViite.tutkinnonOsa.valmaTelmaSisalto : {};
        $scope.editableTutkinnonOsaViite.tutkinnonOsa.valmaTelmaSisalto.osaamisenarviointi = field.path.includes('osaamisenarviointi')
            ? {} : $scope.editableTutkinnonOsaViite.tutkinnonOsa.valmaTelmaSisalto.osaamisenarviointi;
        $scope.editableTutkinnonOsaViite.tutkinnonOsa.valmaTelmaSisalto.osaamistavoite = field.path.includes('osaamistavoite')
        ...
        save: function (kommentti) {
            if ($scope.editableTutkinnonOsaViite.tutkinnonOsa.valmaTelmaSisalto) {
                $scope.editableTutkinnonOsaViite.tutkinnonOsa.valmaTelmaSisalto = {
                    ...
                    osaamisenarviointi: getSisalto($scope.editableTutkinnonOsaViite.tutkinnonOsa.valmaTelmaSisalto.osaamisenarviointi),
                    osaamisenarviointiTekstina: $scope.editableTutkinnonOsaViite.tutkinnonOsa.valmaTelmaSisalto.osaamisenarviointiTekstina
                };
            }
    ...
    function fetch(cb) {
        ...
        PerusteenOsat.get({ osanId: $scope.tutkinnonOsaViite.tutkinnonOsa.id }, function (res) {
            if (res.valmaTelmaSisalto) {
                res.valmaTelmaSisalto.osaamisenarviointi = isEmptyValmaList(res.valmaTelmaSisalto.osaamisenarviointi) ? null :
                    res.valmaTelmaSisalto.osaamisenarviointi;
                res.valmaTelmaSisalto.osaamistavoite = isEmptyValmaList(res.valmaTelmaSisalto.osaamistavoite) ? null :
    ...
    var normalCallbacks = {
        ...
        save: function (kommentti) {
            ...
            $scope.editableTutkinnonOsaViite.metadata = { kommentti: kommentti };
            if ($scope.editableTutkinnonOsaViite.tutkinnonOsa.id) {
                PerusteTutkinnonosa.save({ perusteId: $scope.peruste.id, suoritustapa: $stateParams.suoritustapa, osanId: $scope.editableTutkinnonOsaViite.tutkinnonOsa.id }, $scope.editableTutkinnonOsaViite, function (response) {
                    $scope.editableTutkinnonOsaViite = angular.copy(response);
                    $scope.tutkinnonOsaViite = angular.copy(response);
                    Editointikontrollit.lastModified = response;
                    saveCb(response.tutkinnonOsa);
        ...
        if ($scope.editableTutkinnonOsaViite.tutkinnonOsa.valmaTelmaSisalto) {
            $scope.editableTutkinnonOsaViite.tutkinnonOsa.valmaTelmaSisalto.osaamisenarviointi =
                isEmptyValmaList($scope.editableTutkinnonOsaViite.tutkinnonOsa.valmaTelmaSisalto.osaamisenarviointi) ? null :
                    $scope.editableTutkinnonOsaViite.tutkinnonOsa.valmaTelmaSisalto.osaamisenarviointi;
            $scope.editableTutkinnonOsaViite.tutkinnonOsa.valmaTelmaSisalto.osaamistavoite =
                isEmptyValmaList($scope.editableTutkinnonOsaViite.tutkinnonOsa.valmaTelmaSisalto.osaamistavoite) ? null :
                    $scope.editableTutkinnonOsaViite.tutkinnonOsa.valmaTelmaSisalto.osaamistavoite;
        }
    ...
    function isEmptyValmaList(item) {
        return ((!item || item === null) || (item.kohde === null && item.selite === null && item.tavoitteet.length === 0));
    }
});
//# sourceMappingURL=koulutuksenosa.js.map