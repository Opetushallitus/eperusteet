...
angular
    ...
    .service("TermistoService", function(TermistoCRUD, Notifikaatiot, $q, $timeout, YleinenData, $rootScope) {
        ...
        this.delete = function(item) {
            return TermistoCRUD.delete(
                { perusteId: peruste.id, id: item.id },
                {},
                function() {
    ...
    .controller("TermistoController", function(
        $scope,
        TermistoService,
        YleinenData,
        Algoritmit,
    ...
    .controller("TermistoMuokkausController", function(
        $scope,
        termimodel,
        Varmistusdialogi,
        $uibModalInstance,
