    ...
    .controller("PerusteprojektisisaltoCtrl", function(
        ...
        $scope.rajaaSisaltoa = function(value, tyyppi) {
            ...
            Algoritmit.kaikilleTutkintokohtaisilleOsille($scope.peruste.sisalto, function(osa, lapsellaOn) {
                ...
                osa.$filtered =
                    (lapsellaOn || Algoritmit.rajausVertailu(value, osa, "perusteenOsa", "nimi")) && omistaaTyoryhman;
                return osa.$filtered;
            });
            $scope.naytaTutkinnonOsat =
                Kaanna.kaanna("tutkinnonosat")
                    .toLowerCase()
                    .indexOf(value.toLowerCase()) !== -1;
            $scope.naytaRakenne =
                Kaanna.kaanna("tutkinnon-rakenne")
                    .toLowerCase()
                    .indexOf(value.toLowerCase()) !== -1;
        };
