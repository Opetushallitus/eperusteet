...
angular.module('eperusteApp')
    .controller('LukiokoulutussisaltoController', function ($scope, perusteprojektiTiedot, Algoritmit, $state, SuoritustavanSisalto, LukioKurssiService, LukiokoulutusService, TekstikappaleOperations, Editointikontrollit, $stateParams, Notifikaatiot, Utils) {
    ...
    .controller('LukioOsalistausController', function ($scope, $state, $stateParams, LukiokoulutusService, $log, virheService) {
    ...
    .controller('LukioOsaAlueController', function ($scope, $q, $stateParams, LukiokoulutusService, ProjektinMurupolkuService) {
    ...
    .controller('LukioOppiaineKurssiPuuController', function ($scope, $stateParams, $q, $translate, $rootScope, $timeout, $log, LukioKurssiService, LukiokoulutusService, $state) {
    ...
    function matchesHaku(node, haku) {
        ...
        var nimi = node.nimi, koodiArvo = node.koodiArvo;
    ...
    $scope.treeOsatProvider = $q(function (resolve) {
        ...
        var treeScope = {
            ...
            template: function (n) {
                var handle = '<span icon-role="drag" class="treehandle"></span>', collapse = '<span ng-show="node.lapset.length" ng-click="toggle(node)" class="colorbox collapse-toggle">' +
...
//# sourceMappingURL=lukiokoulutus.js.map