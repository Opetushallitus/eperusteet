...
angular.module('eperusteApp')
    ...
    .controller('LisaaLukioKurssiController', function ($scope, $state, $q, $stateParams, LukiokoulutusService, LukioKurssiService, YleinenData, LukiokurssiModifyHelpers) {
    $scope.kurssityypit = {};
    $scope.kurssi = {
        nimi: { fi: '' },
        tyyppi: 'PAKOLLINEN',
    ...
    .controller('NaytaLukiokurssiController', function ($scope, $state, LukioKurssiService, $stateParams, YleinenData) {
    ...
    .controller('MuokkaaLukiokurssiaController', function ($scope, $state, LukioKurssiService, $stateParams, YleinenData, $log, $rootScope, LukiokurssiModifyHelpers) {
    $scope.kurssityypit = [];
    YleinenData.lukioKurssityypit().then(function (tyypit) {
        $scope.kurssityypit = tyypit;
    });
...
//# sourceMappingURL=kurssit.js.map