'use strict';
angular.module('eperusteet.esitys').controller('epLukiokoulutusController', function ($q, $scope, $timeout, sisalto, PerusteenOsat, $state, $stateParams, epMenuBuilder, Utils, MurupolkuData, LukioOppiaineet, TermistoService, Kieli, $document, $rootScope, epLukiokoulutusStateService, epEsitysSettings) {
    ...
    var peruste = sisalto[0], oppiaineet = _.zipBy(sisalto[2], 'id');
    ...
    .controller('epLukiokoulutusTekstikappaleController', function ($scope, tekstikappale, epTekstikappaleChildResolver, MurupolkuData, epParentFinder) {
