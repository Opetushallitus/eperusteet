        ...
        contents: [{
            ...
            elements: [{
                ...
                html:
                    ...
                    '     <div>' +
                    '       <button class="btn btn-default" ngf-multiple="true" ng-model-rejected="model.rejected" ngf-accept="\'.jpg,.jpeg,.png\'" ngf-select ng-model="model.files">' +
                    '          <span kaanna="\'epimage-plugin-valitse\'"></span>' +
                    '       </button>' +
                    '       <button ng-disabled="!model.files || model.files.length !== 1" class="btn btn-primary" ng-click="saveNew()" kaanna="lisaa"></button>' +
                    '       <img ng-show="showPreview" ngf-src="model.files[0]" class="epimage-thumb">' +
                    '     </div>' +
