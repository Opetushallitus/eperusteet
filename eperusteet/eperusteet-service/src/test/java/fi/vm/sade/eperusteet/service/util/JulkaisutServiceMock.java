...
public class JulkaisutServiceMock implements JulkaisutService {
    ...
    @Override
    public Page<PerusteenJulkaisuData> getJulkisetJulkaisut(List<String> koulutustyyppi, String nimi, String kieli, boolean tulevat, boolean voimassa, boolean siirtyma, boolean poistuneet, boolean koulutusvienti, Integer sivu, Integer sivukoko) {
        return null;
    }
}
