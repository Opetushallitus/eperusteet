...
create table kaantaja_taito_kohdealue_tutkintovaatimus (
    ...
    tutkintovaatimus_ORDER int4 not null,
    primary key (kaantaja_taito_kohdealue_id, tutkintovaatimus_ORDER)
);
...
create table kaantaja_taito_kohdealue_tutkintovaatimus_AUD (
    ...
    REVTYPE int2,
    REVEND int4,
    primary key (REV, kaantaja_taito_kohdealue_id, tekstipalanen_id, tutkintovaatimus_ORDER)
);
...
create table kaantaja_taito_kohdealue_arviointikriteeri (
    kaantaja_taito_kohdealue_id int8 not null,
    tekstipalanen_id int8 not null,
    arviointikriteeri_ORDER int4 not null,
    primary key (kaantaja_taito_kohdealue_id, arviointikriteeri_ORDER)
);
...
create table kaantaja_taito_kohdealue_arviointikriteeri_AUD (
    ...
    REVTYPE int2,
    REVEND int4,
    primary key (REV, kaantaja_taito_kohdealue_id, tekstipalanen_id, arviointikriteeri_ORDER)
);
