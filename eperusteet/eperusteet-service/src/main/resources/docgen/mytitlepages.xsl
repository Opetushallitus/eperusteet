...
<xsl:template name="book.titlepage.verso">
  ...
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="d:bookinfo/d:para"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="d:info/d:para"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="d:bookinfo/d:formalpara"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="d:info/d:formalpara"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="d:bookinfo/d:informaltable"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="d:info/d:informaltable"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="d:bookinfo/d:simplesect"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="d:info/d:simplesect"/>
</xsl:template>
...
<xsl:template match="d:formalpara" mode="book.titlepage.verso.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.verso.style">
<xsl:apply-templates select="." mode="book.titlepage.verso.mode"/>
</fo:block>
</xsl:template>

<xsl:template match="d:informaltable" mode="book.titlepage.verso.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.verso.style">
<xsl:apply-templates select="." mode="book.titlepage.verso.mode"/>
</fo:block>
</xsl:template>

<xsl:template match="d:simplesect" mode="book.titlepage.verso.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.verso.style">
<xsl:apply-templates select="." mode="book.titlepage.verso.mode"/>
</fo:block>
</xsl:template>
