...
public class PerusteController {
    ...
    @Parameters({
            ...
            @Parameter(name = "koulutusala", schema = @Schema(implementation = String.class), in = ParameterIn.QUERY, array=@ArraySchema(schema = @Schema())),
            ...
            @Parameter(name = "kieli", schema = @Schema(implementation = String.class), in = ParameterIn.QUERY, array=@ArraySchema(schema = @Schema()), description = "perusteen kieli"),
            @Parameter(name = "opintoala", schema = @Schema(implementation = String.class), in = ParameterIn.QUERY, array=@ArraySchema(schema = @Schema()), description = "opintoalakoodi"),
            ...
            @Parameter(name = "tutkinnonosaKoodit", schema = @Schema(implementation = String.class), in = ParameterIn.QUERY, array=@ArraySchema(schema = @Schema())),
            @Parameter(name = "osaamisalaKoodit", schema = @Schema(implementation = String.class), in = ParameterIn.QUERY, array=@ArraySchema(schema = @Schema())),
    })
    ...
    @Parameters({
            ...
            @Parameter(name = "osaamisalat", schema = @Schema(implementation = Boolean.class), in = ParameterIn.QUERY, description = "hae myös osaamisaloista"),
            @Parameter(name = "koulutusvienti", schema = @Schema(implementation = Boolean.class), in = ParameterIn.QUERY, description = "Haku ainoastaan koulutusviennistä"),
            @Parameter(name = "tila", schema = @Schema(implementation = String.class), in = ParameterIn.QUERY, array=@ArraySchema(schema = @Schema()), description = "Sallitut tilat"),
            @Parameter(name = "perusteTyyppi", schema = @Schema(implementation = String.class), in = ParameterIn.QUERY, description = "Perusteen tyyppi"),
            @Parameter(name = "julkaistu", schema = @Schema(implementation = Boolean.class, defaultValue = "false"), in = ParameterIn.QUERY, description = "julkaistut perusteet"),
    })
