...
public class TaitotasoasteikkoKategoria extends AbstractAuditedEntity {
    ...
    private List<TaitotasoasteikkoKategoriaTaitotaso> taitotasoasteikkoKategoriaTaitotaso = new ArrayList<>();
    ...
    public TaitotasoasteikkoKategoria(TaitotasoasteikkoKategoria other) {
        if (other != null) {
            ...
            this.taitotasoasteikkoKategoriaTaitotaso = other.getTaitotasoasteikkoKategoriaTaitotaso().stream()
