...
public class KoodistoUriArvo {
    ...
    public static final String KIELIKOODISTO_OPETUSHALLINTO = "kielikoodistoopetushallinto";
    public static final String KIELIVALIKOIMA = "kielivalikoima";
