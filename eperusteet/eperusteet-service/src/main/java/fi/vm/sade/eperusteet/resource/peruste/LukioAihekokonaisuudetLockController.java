...
public class LukioAihekokonaisuudetLockController extends AbstractLockController<AihekokonaisuusLockContext> {
    ...
    private LockService<AihekokonaisuusLockContext> aihekokonaisuusLockService;

    @Override
    protected LockService<AihekokonaisuusLockContext> service() {
