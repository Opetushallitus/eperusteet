...
public class KaantajaTaitotasoasteikko extends PerusteenOsa {
    ...
    private List<TaitotasoasteikkoKategoria> taitotasoasteikkoKategoria = new ArrayList<>();
    ...
    public NavigationType getNavigationType() {
        return NavigationType.kaantaja_taito;
    }
    ...
    public void mergeState(PerusteenOsa perusteenOsa) {
        ...
        if (perusteenOsa instanceof KaantajaTaitotasoasteikko) {
            ...
            this.taitotasoasteikkoKategoria.clear();
            for (TaitotasoasteikkoKategoria kategoria : other.getTaitotasoasteikkoKategoria()) {
                ...
                this.taitotasoasteikkoKategoria.add(newKategoria);
            }
        }
    }
    ...
    public boolean structureEquals(PerusteenOsa updated) {
        ...
        if (updated instanceof KaantajaTaitotasoasteikko) {
            ...
            if (result && getTaitotasoasteikkoKategoria() != null) {
                Iterator<TaitotasoasteikkoKategoria> i = getTaitotasoasteikkoKategoria().iterator();
                Iterator<TaitotasoasteikkoKategoria> j = that.getTaitotasoasteikkoKategoria().iterator();
    ...
    private void copyState(KaantajaTaitotasoasteikko other) {
        ...
        this.taitotasoasteikkoKategoria = other.getTaitotasoasteikkoKategoria().stream()
